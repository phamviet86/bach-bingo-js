...
export async function createShift(data) {
  try {
    ...
    return await sql`
      INSERT INTO shifts (shift_name, shift_start_time, shift_end_time, shift_status_id, shift_desc)
      VALUES (${shift_name}, ${shift_start_time}, ${shift_end_time}, ${shift_status_id}, ${shift_desc})
      RETURNING *;
    `;
  } catch (error) {
    throw new Error(error.message);
